...
![](/img/automatic-messages-chat-4.png) 4.    Enter the relevant text to the text field. Note that you can add dynamic text (see below).  
 5.    Click **Save**.	

\* Note: The automatic message library can also be reached from the chat settings in the Engagement studio by clicking ‘Customize Automatic Messages’.
