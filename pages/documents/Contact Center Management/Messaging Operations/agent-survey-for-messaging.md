...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-1.png)

The agent survey library will now be displayed.

### Step 2: Click on Add Survey

![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-2.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-3.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-4.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-5.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-6.png)

![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-7.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-8.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-9.png)

![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-9a.png)
...
9. Assign Survey to Skill/s -
  ...
  * In the library view, check the survey you wish to edit. Then click on the Action menu on the top right and choose ‘assign skills’
  ...
  ![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-10.png)

  * Choose the skill(s) you would like to assign to the survey and save the changes:

  ![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-11.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-12.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-13.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-14.png)
...
If the survey has no required questions, a ‘Dismiss’ button will appear.
  ...
  * Upon clicking ‘dismiss’ the agent will be prompted with a warning:
  ...
  ![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-15.png)

  * The widget will have a notification stating the survey was dismissed and at what time

  ![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-16.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-17.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-18.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/agent-survey-for-messaging-19.png)
