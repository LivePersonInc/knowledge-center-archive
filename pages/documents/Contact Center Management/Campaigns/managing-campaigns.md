...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-1.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-2.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-4.png)

{:start="2"}
2\. Busy state enabled

![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-3.png)

{:start="3"}
3\. Busy state disabled, ignore max wait time enabled

![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-5.png)

{:start="4"}
4\. Busy state enabled, ignore max wait time enabled

![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-6.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-7.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-8.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-9.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-10.png)
...
![](//ce-sr.s3.eu-west-1.amazonaws.com/knowledge/img/managing-campaigns-11.png)
