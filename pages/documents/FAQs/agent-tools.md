...
* From the conversation window,
  ...
  (1) click the Predefined Content widget to display a list of predefined content categories (Greeting, Conversational, etc.), 

   (2) click a category to display its list of predefined content. 
*  From the conversation window, 

  (1) open the Predefined Content widget

  (2) enter a string in the search box. 
* Use hotkeys to display a category of predefined content to choose from: 

  (1) Press a letter + right arrow to display the category’s items, 

  (2) then click an item from the list to enter it in the conversation text box. For example, pressing W + right arrow displays the Greeting category’s predefined content.
* Use hotkeys to enter a predefined content item in a conversation: 

  (1) Place your cursor in the conversation text box, 
* (2) press a letter + right arrow + number (the number of the item in the category’s list). For example, press W + right arrow + 1 to enter the first item in the Greeting category. 
