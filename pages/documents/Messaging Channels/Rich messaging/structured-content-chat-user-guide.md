...
![](https://lh5.googleusercontent.com/BQEYg6ENcWzZhyqMxn6EQ22pre3X4MouGEfuNMvnh_--GyElIAUCsQr8lagbTnnRwa5jj4x3owM7qghVCcIICjlRFFjTfLJA6CQizpRRySSOP63JS8suL4TJzaDb9WrSmpXhovmp =261x50)![](https://lh6.googleusercontent.com/eXqn7j2_NreHAkdNp11YmqzLz9bhnUat-1hfZIDcuB7asXSZIjekYXJw_x6Z3gVoGIyKJ3YBMFheuSkHOxuZIFBezAVgSOklXc0FJt4nGTlnTA0g7vbIToWD0cCSFb8-PuiNYCy2 =215x34)![](https://lh6.googleusercontent.com/xi_fnvzcM6GVaSW8mkxUC_8ueQGIQj7qLEhTBRaBKqghsUwnuXwkK3jqYUCoJZuDAYufkjh-mmuHRZCayePRnGMnBAXt7wE8pYK93py5cauQoP7kNxNaPHyrg9qclQ3JcxAEw47T =225x270)

## Enabling structured content 

To build structured content for use on your chat channels, we recommend working with your LivePerson team on the steps below.

Follow the prerequisites and configuration steps in the [Developers Community](https://developers.liveperson.com/rich-messaging-structured-content-overview.html).

# How to build structured content 

To build structured content for use on web chat, we recommend working with your LivePerson team on the steps below.
...
3. You will need to implement a new agent widget based on the [Agent Workspace Widget SDK](https://developers.liveperson.com/agent-workspace-sdk-overview.html). For further information, refer to the [Developer Community documentation](https://developers.liveperson.com/rich-messaging-structured-content-overview.html#agent).
...
4. Break each of your identified use cases down into the following building elements:
