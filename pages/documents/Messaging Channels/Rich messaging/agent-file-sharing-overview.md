...
Agent file sharing enables agents and bots to share files with consumers. At this phase, **photos and certain file types** can be shared via **web messaging, as well as the Apple Business Chat and WhatsApp Business connectors.** In the future, more file formats will be supported.
