...
1. Upgrade from your trial account and purchase credits.
2. Configure the request URL, by navigating to the following page: [https://www.twilio.com/user/account/phone-numbers/incoming](https://www.twilio.com/user/account/phone-numbers/incoming "https://www.twilio.com/user/account/phone-numbers/incoming")
...
1. On the conversation sources tab, click on Connect in the Twilio SMS box.
2. Toggle the Activate Twilio SMS Source to enabled.
3. Under Twilio account configuration, enter the following details from your Twilio account:
