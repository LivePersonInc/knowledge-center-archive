...
redirect:
- data-reporting-analytics-performance-optimizer-user-guide.html
---
## Introduction
...
5. The Metric Targets area lists metrics that are key drivers for the 4 categories of the 4E Framework. For each metric: 
