...
var taginput =
  '<div class="taginputcontainer"><div class="inputArea"><input type="text" id="tagInput" placeholder="Enter your 8 digit account number here"/><div class="submitContainer"><img src="https://www.liveperson.com/sites/default/files/conv_page/send.png" class="tagSubmit"/></div></div><div class="statusRow"><span class="errorShort">Too short!</span><span class="accountSuccess">Perfect!</span><span class="errorLong">Too long!</span><span class="errorInvalid">Account number is not valid!</span><div class="lp-json-pollock"><div class="lp-json-pollock-layout lp-json-pollock-layout-vertical"><div class="lp-json-pollock-element-button searchButton"><button title="Go back" aria-label"Go back">Go back</button></div></div></div></div></div>';
let isScrolling;
let agentFirstText;
          ...
          if (errorStatus) {
            ...
            setTimeout(function() {
              $("#caseyContainer").append(
                "<div class='caseyTextContainer noOpacity'><img class='caseyAvatar' src='img/avatar-casey.svg'/><div class='caseyText'>Here's your code snippet. <a class='copylink' data-clipboard-target='.caseyCode' href=''>Copy it</a> and add to your website, for more info <a href='https://knowledge.liveperson.com/getting-started-add-the-liveperson-tag-to-your-website.html'>click here</a>.</div></div><div class='caseyTextContainer noOpacity'><img class='caseyAvatar' src='img/avatar-casey.svg'/><div class='caseyText caseyCode'><code class='highlighter-rouge language-javascript'><span>" + tagMessageString + "</span></code></div></div>"
              );
              copyLink();
            }, 1000);
            //change the id of the input field used to make sure it doesn't get picked up when this function runs again - there can only be one!
